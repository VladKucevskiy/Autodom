    ...
    <div class="container">
        <div class="row">
            <ul>
                ...
                <li class="active"><a href="Novosti.php">Новости</a></li>
...
<article class="news">
    ...
    <div class="newsImages">
        <img src="img/hins.jpg" alt="">
    </div>
    <section class="Text-News">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, sint! Illo fuga maiores quo fugiat molestias sunt placeat recusandae qui, pariatur nam aliquam ut perspiciatis iste quis. Explicabo, debitis ipsam.</p>
    </section>
</div>
<?php
        include('index10.php');

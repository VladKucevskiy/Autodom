...
<body>
		...
		<div class="container">
			<div class="row">
				<ul>
                    ...
                    <li><a href="add-tov.php">Добавить товар</a></li>
                    <li class="active"><a href="tovar.html">Товары</a></li>
				</ul>
				<div class="waranty">
	...
	<section class="main_cats s_black">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>Товары мастерской <strong>Авто</strong><span>Дом</span></h2>
				</div>
			</div>
		</div>	
		<div class="container mt-5">
			<div class="row">
		 		<div class="col-md-3">
					<div class="product">
						<div class="image">
							<img src="img/15c9e0_castrol_magnatec_5w-40_a3b4_4l.jpg" alt="">
						</div>
						<div class="info">
							...
							<div class="info-price">
								<span class="price">230<small>P</small></span>

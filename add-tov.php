...
if (isset($_POST['insert']))
{
    ...
    $productPic = 'img/'.$fileName;
    $cost = $_POST['cost'];
    $productAvailable = $_POST['productAvailable'];
    
    $connect = mysqli_connect ($hostname, $username, $password, $databaseName);
    $query = "INSERT INTO `products`(`productDate`, `productNumber`, `name`, `productPic`, `cost`, `productAvailable`)
     VALUES ('$DateTime', '$productNumber', '$productName', '$productPic', '$cost','$productAvailable')";
    ...
    <div class="container">
        <div class="row">
            <ul>
                ...
                <li class="active"><a href="add-tov.php">Добавить товар</a></li>
...
<div class="formContent">
    <form action="add-tov.php" method="post" enctype="multipart/form-data">              
        <div class="inpNameNews">
            <input type="text" size="50" placeholder="Заголовок товара" name="name">
        </div> <br>
        <input type="file" name="productPic" value="Добавить картинку" class="addImg"> <br>
        <input type="text" name="cost" placeholder="Указать цену"> <br>
        <input type="text" name="productNumber" placeholder="Указать номер"> <br>
        <input type="text" name="productAvailable" placeholder="Указать наличие"> <br>
        <input type="submit" name="insert" value="Добавить товар"><br>
    </form> 
</div>  
</article>
<footer>

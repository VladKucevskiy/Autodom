...
if (isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO news(DateTime, NewsName, News) VALUES ('$DateTime', '$NewsName', '$News')";
...
<div class="newsNews">
 ...
 <div class="newsData"> 
        <input type="text" placeholder="Дата: День.Месяц.Год ">
        </div> 
        <div class="newsName">
        <input type="text" placeholder="Заголовок новости" name="NewsName">
        </div>
    </div>
    <section class="Text-News">
       <textarea name="News" placeholder="Текст новости" cols="100" rows="25"></textarea>
    </section>
</div>
<input type="submit" name="insert" value="Add Data to Database"><br><br>
</form>   
</article>
<footer>
    <div class="container">
